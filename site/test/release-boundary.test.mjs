...
test("the public install and checkout pages state the local and quantity-one contracts", () => {
  buildSite();
  ...
  assert.match(checkout, /multi-unit checkout\s+is not supported in the current release/i);
